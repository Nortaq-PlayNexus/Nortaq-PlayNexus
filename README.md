...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=B8FF1E&center=true&vCenter=true&multiline=true&repeat=true&width=600&height=100&lines=DJ+PHANTOMTAPE%3BPIRATE+DIGITAL+BROADCAST%3B103.7+FM+%E2%9C%93" alt="PHANTOMTAPE typing banner" />
</div>
...
<p align="left">
  <picture>
    ...
    <img src="https://raw.githubusercontent.com/Nortaq-PlayNexus/Nortaq-PlayNexus/main/assets/hero.svg" alt="PHANTOMTAPE hero: signal detected, DJ PHANTOMTAPE, digital audio, software, experiments - transmission online" width="100%" />
  </picture>
...
```mermaid
graph TB
    CORE["◉ CORE<br/>Nortaq-PlayNexus"]
    CORE --> AUDIO["~ AUDIO<br/>9 repos"]
    CORE --> AI["@ AI<br/>14 repos"]
    CORE --> SYS["# SYSTEMS<br/>7 repos"]
    CORE --> EARTH["* EARTH<br/>4 repos"]
    CORE --> GAME["x GAMING<br/>3 repos"]
    CORE --> DATA["+ DATA<br/>4 repos"]

    AUDIO --> SYNTH["synthesis-dj<br/>JS | ● ONLINE"]
    AUDIO --> AURORA["aurora-audio-engine<br/>Rust | ⚠ EXPERIMENTAL"]
    AUDIO --> SONIC["sonic-facility<br/>Python | ◆ SHIPPED"]
    AUDIO --> DJ["dj-festival-audio-polisher<br/>Python | ◆ SHIPPED"]

    AI --> NEXUS["nexus-agent-x<br/>Python | ● ACTIVE"]
    AI --> HEART["heart<br/>Python | ◆ SHIPPED"]
    AI --> SWARM["swarmforge<br/>Python | ● ACTIVE"]
    AI --> SENT["sentinel<br/>Python | ● ACTIVE"]

    SYS --> FORGE["forge<br/>Python | ● ACTIVE"]
    SYS --> FOUNDRY["PlayNexus-Foundry<br/>TS | ◐ DEV"]
    SYS --> SECURE["SecureVault<br/>C# | ● ACTIVE"]

    EARTH --> ORION["orion-sentinel-ai<br/>JS | ◐ DEV"]
    EARTH --> NASA["nasa-investigation<br/>HTML | ◆ SHIPPED"]

    GAME --> ARK["ArkNexusX<br/>Rust | ● ACTIVE"]
    GAME --> TERROR["TerrorFibercraft<br/>Python | ● ACTIVE"]

    style CORE fill:#B8FF1E,stroke:#0a0e1a,color:#0a0e1a
    style AUDIO fill:#FF3B3B,stroke:#0a0e1a,color:#fff
    style AI fill:#B8FF1E,stroke:#0a0e1a,color:#0a0e1a
    style SYS fill:#00E5FF,stroke:#0a0e1a,color:#0a0e1a
    style EARTH fill:#FFC430,stroke:#0a0e1a,color:#0a0e1a
    style GAME fill:#FF4D00,stroke:#0a0e1a,color:#fff
    style DATA fill:#9B59B6,stroke:#0a0e1a,color:#fff
```
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Nortaq-PlayNexus/Nortaq-PlayNexus/main/assets/snake-signal-dark.svg" alt="GitHub contribution snake recolored in acid green signal palette, updated nightly" width="100%" />
  <em><code>snake via Platane/snk -- generated daily at 00:00 UTC</code></em>
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/Nortaq-PlayNexus/Nortaq-PlayNexus/main/assets/crt-equalizer.svg" alt="CRT equalizer visualization of contribution activity, retro phosphor green" width="100%" />
...
│ UPLINK AGE ........   44 DAYS │
│ SIGNAL HASH ....... 0A52BF   SIGNAL ......... ###########=....  83%  PHASE 07 │
└──────────────────────────────────────────────────────┘
...
FOLLOWERS .......... 2
COLLECTED STARS .... 9
BROADCASTING FOR ... 44 DAYS (SINCE 2026-07-31 UTC)

// RECENT CATCHES -- LAST 3 PUSHES
  Nortaq-PlayNexus             PUSHED 2026-09-13
...
<sup>LAST REBROADCAST 20260913 UTC . data source: GRAPHQL . hash salt public in docs/how-to-verify.md</sup>
...
MOST ACTIVE (7 DAYS):
  ...
  02 orion-sentinel-ai              2d ago
  03 counter-intel                  2d ago
  04 hwid-sentinel                  2d ago
  05 rust-voice-booster             2d ago
...
ANOMALIES:
  [!] cookiecutter-wagtail-vix -- no activity for 31 days
  [!] python-hid-parser -- no activity for 32 days
  [!] pygeofilter -- no activity for 42 days
